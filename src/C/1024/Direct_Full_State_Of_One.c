...
//////////////////////////////////////////////////////////////////////////////////////////////
//  This implementation is for q=1 (One SuperBlock), 32-bits words and a block size of 1024  //
//////////////////////////////////////////////////////////////////////////////////////////////
...
void main()
{
    ...
    sha3_1024(out, size, convert_array_32_to_8_bit(F, 2 * p, tmp), 2 * p * 32 / 8);
    ...
    for (int j = 0; j <= 2 * p * 32 - 1; j++)
    {
        ...
        for (int t = 0; t <= 99; t++)
        {
            ...
            sha3_1024(out, size, convert_array_32_to_8_bit(Zn, 2 * p + 1, tempo), (2 * p + 1) * 32 / 8);
